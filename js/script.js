...
// The game data with the narrative fixes.
const gameData = {
    ...
    // --- CHANGE 1: Leo is now eating a hot dog instead of opening presents. ---
    step2_calm: {
        illustration: '🥳🌭', // Illustration changed to party face with hot dog.
        text: "You see Leo by the food table, eating a hot dog. He looks happy! It's polite to say hello to the birthday kid.", // Text changed.
        choices: [
    ...
    // --- CHANGE 2: The "play tag by yourself" phrasing is updated. ---
    step5_present: {
        illustration: '🎁🎁🎁',
        ...
        choices: [
            ...
            { text: "Keep running around by yourself.", next: 'step5_bad', isMistake: true } // Phrasing changed here.
        ]
    },
